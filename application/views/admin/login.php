                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="<?php echo base_url("a_dashboard"); ?>" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                        <hr>
                                        <a href="<?php echo base_url("a_dashboard"); ?>" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Login with Google
                                        </a>
                                        <a href="<?php echo base_url("a_dashboard"); ?>" class="btn btn-facebook btn-user btn-block">
